...
CURL *handel;
  handel = curl_easy_init();
   ...
   char  postdata[1024];
    ...
    printf(GRV_GRAY "\n  Format examples:\n");
    printf("  • " GRV_AQUA "name=John+Doe&email=john%%40gmail.com&id=123&action=update&status=active\n");
;
    
    printf(GRV_GRAY "\n  Rules:\n");
    printf("  • Key-value pairs separated by " GRV_YELLOW "&\n");
    printf("  • Keys and values separated by " GRV_YELLOW "=\n");
    printf("  • Spaces become " GRV_YELLOW "+\n");
    printf("  • Special chars URL-encoded (@ = %%40)\n" RESET);
...
curl_easy_setopt(handel,CURLOPT_POSTFIELDS,postdata);
